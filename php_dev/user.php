<?php
  ...
  $applications = mysqli_fetch_all($result_lots, MYSQLI_ASSOC);
    ...
    $content = include_template('user1.php', ['user' => $user, 'connection' => $connection, 'applications' => $applications, 'user_subjects' => $user_subjects, 'user_help_subjects' => $user_help_subjects, 'subjects' => $subjects, 'my_account' => $my_account, 'id' => $id, 'visitor' => $_SESSION['user_id'], 'chat_href' => $chat_href]);
